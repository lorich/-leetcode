...
public:
    int countPrimes(int n) {
    	...
    	for (i = 2; i < n; ++i)
    	{
    		...
    		for (j = 0; j < iTotal && i*prime[j] < n; ++j)
    		{
...
public int countPrimes(int n) {
 ...
 Subscribe to see which companies asked this question. Show Tags Hash Table Math Show Similar Problems (E) Ugly Number (M) Ugly Number II (M) Perfect Squares
*/
